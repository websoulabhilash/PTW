...
export const Header1 = () => {
    ...
    return (
        <>
            <AppBar color='primary' style={{height:"3.5rem"}} position='sticky' >
            <Toolbar>
            ...
            <Button variant='contained' className="english-button" aria-controls='menu' onMouseUp={handleOpenMenu} style={{backgroundColor:"#fd7e14", color:"white",height:"3rem",marginLeft:"2rem",textTransform:"capitalize",position:"relative" }} >English<i class='fas fa-angle-down'></i></Button>
            </>
            )
            }
            </Toolbar>
